      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 12, marginBottom: 30 }}>
            {genre && (
              <div style={{
                fontSize: 23, color: 'var(--color-text-inverse)', background: 'linear-gradient(135deg, var(--color-brand), #D9531A)',
            ...
            {novelType && (
              <div style={{
                fontSize: 23, color: '#1d4ed8', background: 'var(--color-bg-card)',
          ...
          {catchcopy && (
            <div style={{
              ...
              background: 'color-mix(in srgb, var(--base-color-1) 55%, transparent)',
