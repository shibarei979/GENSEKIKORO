...
export default function ExportButton({ novelId, novelTitle, authorName }: Props) {
  ...
  async function exportPdf() {
    ...
    win.document.write(`
      ...
      <body>
        <div class="no-print" style="writing-mode:horizontal-tb;padding:16px;background:#FFF1E6;text-align:center;">
          <button onclick="window.print()" style="padding:10px 24px;font-size:14px;background:#F26A21;color:#fff;border:none;border-radius:8px;cursor:pointer;">PDFとして保存 / 印刷</button>
