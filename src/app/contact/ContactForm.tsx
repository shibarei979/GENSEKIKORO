...
export default function ContactForm({ userId, userEmail, userName }: Props) {
  ...
  if (sent) {
    return (
      <div style={{background:'#fff',border:'1px solid #F0D9C9',borderRadius:12,padding:'48px 32px',textAlign:'center'}}>
        <div style={{fontSize:16,fontWeight:700,color:'#2B211B',marginBottom:10}}>お問い合わせを受け付けました</div>
        <p style={{fontSize:13,color:'#77706A',lineHeight:1.9}}>
  ...
  return (
    <div style={{background:'#fff',border:'1px solid #F0D9C9',borderRadius:12,overflow:'hidden'}}>
      ...
      {/* お問い合わせ区分 */}
      <div style={rowStyle}>
        <label style={{fontSize:13,fontWeight:600,color:'#2B211B',display:'block',marginBottom:8}}>
          お問い合わせ区分<span style={{color:'#F26A21',marginLeft:4,fontSize:11,fontWeight:700}}>必須</span>
        </label>
      ...
      <div style={rowStyle}>
        <label style={{fontSize:13,fontWeight:600,color:'#2B211B',display:'block',marginBottom:8}}>
          お名前<span style={{color:'#F26A21',marginLeft:4,fontSize:11,fontWeight:700}}>必須</span>
        </label>
      ...
      {senderType === 'business' && (
        <div style={rowStyle}>
          <label style={{fontSize:13,fontWeight:600,color:'#2B211B',display:'block',marginBottom:8}}>
            会社名・組織名<span style={{color:'#F26A21',marginLeft:4,fontSize:11,fontWeight:700}}>必須</span>
          </label>
      ...
      <div style={rowStyle}>
        <label style={{fontSize:13,fontWeight:600,color:'#2B211B',display:'block',marginBottom:8}}>
          メールアドレス<span style={{color:'#F26A21',marginLeft:4,fontSize:11,fontWeight:700}}>必須</span>
        </label>
      ...
      <div style={rowStyle}>
        <label style={{fontSize:13,fontWeight:600,color:'#2B211B',display:'block',marginBottom:8}}>
          電話番号<span style={{color:'#B8AEA8',marginLeft:4,fontSize:11}}>任意</span>
        </label>
      ...
      <div style={rowStyle}>
        <label style={{fontSize:13,fontWeight:600,color:'#2B211B',display:'block',marginBottom:8}}>
          お問い合わせ内容<span style={{color:'#F26A21',marginLeft:4,fontSize:11,fontWeight:700}}>必須</span>
        </label>
        {senderType ? (
          ...
          <div style={{fontSize:12,color:'#B8AEA8',padding:'8px 0'}}>先にお問い合わせ区分を選択してください</div>
        )}
      </div>
      ...
      <div style={{padding:'16px 24px'}}>
        <label style={{fontSize:13,fontWeight:600,color:'#2B211B',display:'block',marginBottom:8}}>
          本文<span style={{color:'#F26A21',marginLeft:4,fontSize:11,fontWeight:700}}>必須</span>
        </label>
        ...
        <div style={{fontSize:11,color:'#B8AEA8',marginTop:4,textAlign:'right'}}>{body.length} / 1,000文字</div>
      </div>

      {/* 注意事項 */}
      <div style={{padding:'0 24px 8px'}}>
        <p style={{fontSize:12,color:'#77706A',lineHeight:1.8,margin:0}}>
      ...
      <div style={{padding:'20px 24px',textAlign:'center'}}>
        <button onClick={handleSubmit} disabled={loading}
          style={{padding:'12px 48px',background:'#F26A21',color:'#fff',border:'none',borderRadius:6,fontSize:14,fontWeight:700,cursor:'pointer',opacity:loading?0.6:1}}>
          {loading ? '送信中...' : '送信する'}
        </button>
      </div>
    </div>
