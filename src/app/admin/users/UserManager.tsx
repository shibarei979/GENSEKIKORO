    ...
    <div>
      ...
      {adminModal && (
        <div style={{position:'fixed',inset:0,background:'rgba(0,0,0,0.5)',zIndex:9999,display:'flex',alignItems:'center',justifyContent:'center',padding:16}}>
          <div style={{background:'#fff',borderRadius:16,padding:'28px',maxWidth:420,width:'100%',boxShadow:'0 8px 32px rgba(0,0,0,0.2)'}}>
            ...
            {adminStep === 1 && (
              <>
                ...
                <div style={{display:'flex',gap:8,justifyContent:'flex-end'}}>
                  <button onClick={closeAdminModal} style={btn('#64748b','#fff','#e2e8f0')}>キャンセル</button>
                  <button onClick={() => setAdminStep(2)} style={btn('#fff','#f59e0b','#f59e0b')}>次へ →</button>
                </div>
              </>
            )}
              ...
              <>
                ...
                <div style={{display:'flex',gap:8,justifyContent:'flex-end'}}>
                  ...
                  <button onClick={() => setAdminStep(3)} disabled={adminInput !== '権限を付与する'}
                    style={{...btn('#fff', adminInput === '権限を付与する' ? '#dc2626' : '#fca5a5', adminInput === '権限を付与する' ? '#dc2626' : '#fca5a5'), opacity: adminInput === '権限を付与する' ? 1 : 0.5}}>
                    次へ →
                  </button>
                </div>
              </>
