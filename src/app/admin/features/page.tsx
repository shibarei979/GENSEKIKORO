...
import FeatureFlagsManager from '@/components/admin/features/feature-flags-manager'
    ...
    <div style={{ minHeight: '100vh', background: 'var(--admin-bg, #f8fafc)' }}>
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '32px 20px' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 8, marginBottom: 6 }}>
          ...
          <a href="/admin" style={{ fontSize: 13, fontWeight: 600, color: '#2563eb', textDecoration: 'none', border: '1px solid #e2e8f0', borderRadius: 10, padding: '6px 14px', background: 'var(--color-bg-card)' }}>← 管理画面トップ</a>
        </div>
