        ...
        <>
          ...
          <div style={{ background: 'var(--color-bg-card)', border: '1px solid var(--color-brand-border)', borderRadius: 12, padding: '16px', marginBottom: 24 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
              ...
              <button onClick={handleAdd} style={{ background: 'var(--color-brand)', color: 'var(--color-text-inverse)', border: 'none', borderRadius: 8, padding: '7px 16px', fontSize: 12, cursor: 'pointer', whiteSpace: 'nowrap' }}>追加</button>
            </div>
          </div>
