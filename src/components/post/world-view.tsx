            ...
            {(selected as any).image_url ? (
              <div style={{ position: 'relative', display: 'inline-block' }}>
                ...
                <button onClick={handleImageRemove}
                  style={{ position: 'absolute', top: 4, right: 4, width: 20, height: 20, borderRadius: '50%', background: 'rgba(0,0,0,0.6)', color: 'var(--color-text-inverse)', border: 'none', cursor: 'pointer', fontSize: 11, lineHeight: 1 }}>×</button>
              </div>
            ) : (
