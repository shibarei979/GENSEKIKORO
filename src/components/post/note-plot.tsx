...
import PlanView from '@/components/post/plan-view'
import PlotView from '@/components/post/plot-view'
import PlotMakerView from '@/components/post/plot-maker-view'
import TimelineView from '@/components/post/timeline-view'
