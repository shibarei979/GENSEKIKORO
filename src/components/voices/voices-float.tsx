  ...
  return (
    <button
      ...
      style={{
        ...
        color:'color-mix(in srgb, var(--base-color-1) 92%, transparent)',
        ...
        textShadow:'0 0 12px color-mix(in srgb, var(--base-color-1) 40%, transparent), 0 0 4px color-mix(in srgb, var(--color-brand) 30%, transparent)',
        padding:'4px 8px',
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{fontSize:18,fontWeight:700,color:'color-mix(in srgb, var(--base-color-1) 90%, transparent)',fontFamily:"'Noto Serif JP',serif",marginBottom:4}}>文章から探す</h1>
        <p style={{fontSize:11.5,color:'color-mix(in srgb, var(--base-color-1) 55%, transparent)'}}>気になる言葉をクリックすると、その作品に出会えます</p>
      </div>

      {voices.length === 0 && (
        <div style={{position:'absolute',inset:0,display:'flex',alignItems:'center',justifyContent:'center'}}>
          <p style={{fontSize:13,color:'color-mix(in srgb, var(--base-color-1) 40%, transparent)'}}>まだ声が集まっていません</p>
        </div>
      )}
      ...
      <style>{`
        ...
        .voice-float-item:hover {
          ...
          text-shadow: 0 0 20px color-mix(in srgb, var(--color-brand) 70%, transparent) !important;
